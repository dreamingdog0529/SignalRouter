...
With squash merge, the PR title becomes the commit on the default branch.
-->
...
- [ ] Tests pass (`dotnet test`) (or N/A for docs-only)
- [ ] Tests added/updated
...
- [ ] No secrets, credentials, or build artifacts (`bin/`, `obj/`, `dist/`, `build/`) included
