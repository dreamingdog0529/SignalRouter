...
/// are the working record; the committed baseline lives in bench/BASELINE.md.
/// </summary>
[NonParallelizable]
...
public sealed class KernelAllocationCharacterizationTests
{
    ...
    private static void Report(string operation, long bytes) =>
        TestContext.Out.WriteLine(
            $"[allocation-characterization] {operation}: {bytes} B/op (non-gating; see bench/BASELINE.md)");
}
