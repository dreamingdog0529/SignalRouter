...
/// <summary>
/// Pins the exported surface of every production assembly against a
...
public sealed class ApiSurfaceSnapshotTests
{
    ...
    {
        "SignalRouter.AdapterSdk",
        "SignalRouter.Codec.CanonicalState",
        "SignalRouter.Codec.Recording",
        "SignalRouter.Comparison",
        "SignalRouter.Recording",
        "SignalRouter.Replay",
        "SignalRouter.Contracts",
        "SignalRouter.Kernel",
        "SignalRouter.ReferenceAdapter",
        "SignalRouter.Tck",
    };
    ...
    private static string BaselineDirectory()
    {
        ...
        var baselines = Path.Combine(
            directory!.FullName, "tests", "SignalRouter.ApiSurface.Tests", "Baselines");
