...
## [0.2.0](https://github.com/dreamingdog0529/SignalRouter/compare/v0.1.0...v0.2.0) (2026-07-28)


### ⚠ BREAKING CHANGES

* **v2:** the Kernel public surface gains the recording control and coordinator seam; API baseline regenerated (+57 lines).
* **v2:** `AdmissionEvidence`/`TerminalEvidence` constructors change; Kernel API baseline regenerated.
* **v2:** make PumpReport a value type - the quiescent pump reaches zero ([#60](https://github.com/dreamingdog0529/SignalRouter/issues/60))
* **v2:** replace ValueList with the struct-backed ValueArray ([#58](https://github.com/dreamingdog0529/SignalRouter/issues/58))

### Features

* add dormant hello authentication plumbing (item 9 auth, phase 2) ([#28](https://github.com/dreamingdog0529/SignalRouter/issues/28)) ([4f50630](https://github.com/dreamingdog0529/SignalRouter/commit/4f50630cfd26a66c9c99c26aad89e1ffb3f83dae))
* bound the agent semantic-UI snapshot (item 9 resource limits) ([#26](https://github.com/dreamingdog0529/SignalRouter/issues/26)) ([3999714](https://github.com/dreamingdog0529/SignalRouter/commit/39997143667c48e43526d54c3e7492942f986fd7))
* **comparison:** add the typed semantic comparator leaf ([#72](https://github.com/dreamingdog0529/SignalRouter/issues/72)) ([65d3853](https://github.com/dreamingdog0529/SignalRouter/commit/65d385388524b4bcf08fc5eb204338512b97af12))
...
* host discovery descriptor store with strict parsing and owner-only ACLs (item 9 auth, phase 3) ([#29](https://github.com/dreamingdog0529/SignalRouter/issues/29)) ([663907e](https://github.com/dreamingdog0529/SignalRouter/commit/663907ee8e1949134248a3fa477dbb4e8e83f101))
...
* **replay:** add the pre-scan and trust boundary ([#73](https://github.com/dreamingdog0529/SignalRouter/issues/73)) ([b04ce7e](https://github.com/dreamingdog0529/SignalRouter/commit/b04ce7e9c2045cc5db64176965e6ee1a56a82d29))
* **replay:** add the replay driver and the required end-to-end proofs ([#74](https://github.com/dreamingdog0529/SignalRouter/issues/74)) ([f8edf93](https://github.com/dreamingdog0529/SignalRouter/commit/f8edf93b31c15180e7a83856e008ecea989bc28a))
...
* **v2:** add SignalRouter.V2.Contracts with the guarantees fixture oracle ([#33](https://github.com/dreamingdog0529/SignalRouter/issues/33)) ([19c8c11](https://github.com/dreamingdog0529/SignalRouter/commit/19c8c11c359b940daa4e0cd49b092bfdb657966d))
* **v2:** add the durable evidence coordinator ([#70](https://github.com/dreamingdog0529/SignalRouter/issues/70)) ([5284589](https://github.com/dreamingdog0529/SignalRouter/commit/5284589cea06a8b9a2e8b966ed1b305ee9c479fa))
* **v2:** add the kernel recording lifecycle state machine ([#69](https://github.com/dreamingdog0529/SignalRouter/issues/69)) ([a499102](https://github.com/dreamingdog0529/SignalRouter/commit/a49910216c29c69662ad998705c8418528cf62a3))
* **v2:** add the predicate subsystem and the AdapterSdk shape assembly ([#35](https://github.com/dreamingdog0529/SignalRouter/issues/35)) ([ef6ba2c](https://github.com/dreamingdog0529/SignalRouter/commit/ef6ba2c382d332d32424d5677cff888ea0724d10))
* **v2:** add the RecordingEventSchema@1.0 artifact codec leaf ([#68](https://github.com/dreamingdog0529/SignalRouter/issues/68)) ([68b61e9](https://github.com/dreamingdog0529/SignalRouter/commit/68b61e92929c80ab6a1ab5a853eb932ee87e1b6e))
* **v2:** add the single-owner kernel with conformance tier-1 tests ([#36](https://github.com/dreamingdog0529/SignalRouter/issues/36)) ([a66ede3](https://github.com/dreamingdog0529/SignalRouter/commit/a66ede3103f05368e8862f35d116dad08169b2fa))
* **v2:** add the StateStore core, checkpoint timeline, and record seam ([#40](https://github.com/dreamingdog0529/SignalRouter/issues/40)) ([ae1b24b](https://github.com/dreamingdog0529/SignalRouter/commit/ae1b24b2dd4b9a53214c3421f36785e0248edc87))
* **v2:** make the kernel's evidence materials E2- and E4-sufficient ([#67](https://github.com/dreamingdog0529/SignalRouter/issues/67)) ([5646a6b](https://github.com/dreamingdog0529/SignalRouter/commit/5646a6b6c644bfbbf37b9ca1a64103c87fb1cd96))
...
* **v2:** batch mailbox depth reads, cache reserved kinds, binary-search lookups ([#54](https://github.com/dreamingdog0529/SignalRouter/issues/54)) ([e8cd8f4](https://github.com/dreamingdog0529/SignalRouter/commit/e8cd8f4ab7014ff160b1fd7ea26663131299dd85))
* **v2:** bring the performance spec into force with owner-indexed lease release ([#63](https://github.com/dreamingdog0529/SignalRouter/issues/63)) ([2eb2613](https://github.com/dreamingdog0529/SignalRouter/commit/2eb261381261f900b1c42527e4d3f87884811f5c))
* **v2:** index terminal retention and wait timeouts by deadline ([#52](https://github.com/dreamingdog0529/SignalRouter/issues/52)) ([741fa17](https://github.com/dreamingdog0529/SignalRouter/commit/741fa17125fa521777f52ec13221dd181ded35a3))
* **v2:** keep canonically-ordered aggregates instead of re-copying them ([#59](https://github.com/dreamingdog0529/SignalRouter/issues/59)) ([0bc0a69](https://github.com/dreamingdog0529/SignalRouter/commit/0bc0a696e1268abebd56c6de75f9c14ec78b0dfe))
* **v2:** make PumpReport a value type - the quiescent pump reaches zero ([#60](https://github.com/dreamingdog0529/SignalRouter/issues/60)) ([f82c68d](https://github.com/dreamingdog0529/SignalRouter/commit/f82c68d6ffc6e398a6d0914292fb47067999b816))
* **v2:** parse field paths by span and search lookups without splitting ([#56](https://github.com/dreamingdog0529/SignalRouter/issues/56)) ([f001c4f](https://github.com/dreamingdog0529/SignalRouter/commit/f001c4f6c142bb6b017ed4a93bd3117f73066309))
* **v2:** rebuild the trace ring as a preallocated circular buffer ([#51](https://github.com/dreamingdog0529/SignalRouter/issues/51)) ([666f44f](https://github.com/dreamingdog0529/SignalRouter/commit/666f44ff62c909a24f7ea75c871c2895898b612b))
* **v2:** replace ValueList with the struct-backed ValueArray ([#58](https://github.com/dreamingdog0529/SignalRouter/issues/58)) ([4c63dc4](https://github.com/dreamingdog0529/SignalRouter/commit/4c63dc4715e93c213784a012fca29ed4752eb721))
* **v2:** republish the status snapshot on change only ([#50](https://github.com/dreamingdog0529/SignalRouter/issues/50)) ([55b968b](https://github.com/dreamingdog0529/SignalRouter/commit/55b968be0988deefdef643c7cb8215734a4bf82a))
* **v2:** reuse runtime-owned projection scratch across materializations ([#61](https://github.com/dreamingdog0529/SignalRouter/issues/61)) ([91491a4](https://github.com/dreamingdog0529/SignalRouter/commit/91491a4d8e72c7b56db50a2e4e713d54b36930e0))
* **v2:** share one wait-evaluation read per domain on revision advance ([#53](https://github.com/dreamingdog0529/SignalRouter/issues/53)) ([cb7ee60](https://github.com/dreamingdog0529/SignalRouter/commit/cb7ee600be81686c6fde7e022c63b96cf7067c8d))
* **v2:** stage canonical encoding in pooled buffers with span writes ([#62](https://github.com/dreamingdog0529/SignalRouter/issues/62)) ([2c51fa9](https://github.com/dreamingdog0529/SignalRouter/commit/2c51fa9cd04984568041af9cbfd1feebb162e012))


### Documentation

* add ADR 0008 security model for item 9 ([#25](https://github.com/dreamingdog0529/SignalRouter/issues/25)) ([1eeeff2](https://github.com/dreamingdog0529/SignalRouter/commit/1eeeff2c5fd5965786b6adcad9d8c1bc50dd9ec8))
* add the clean-slate v2 design set (philosophy, specs, ADRs) ([#30](https://github.com/dreamingdog0529/SignalRouter/issues/30)) ([0e68a83](https://github.com/dreamingdog0529/SignalRouter/commit/0e68a83321978446b06eda586489aa48acdc29cc))
* add the MCP verification surface to the v2 design set ([#31](https://github.com/dreamingdog0529/SignalRouter/issues/31)) ([767234a](https://github.com/dreamingdog0529/SignalRouter/commit/767234a5c1619b82e0af37e011658754b19bf44f))
...
* revise ADR 0008 authentication design after review ([#27](https://github.com/dreamingdog0529/SignalRouter/issues/27)) ([bfb6b8e](https://github.com/dreamingdog0529/SignalRouter/commit/bfb6b8e3a406b4f9c74d9454856fb30c45f794ea))
...
* **v2:** add the performance spec, ADR 0013, and ADR 0014 ([#57](https://github.com/dreamingdog0529/SignalRouter/issues/57)) ([d387594](https://github.com/dreamingdog0529/SignalRouter/commit/d38759425fa055e78dad29369d8724157747dfa4))
* **v2:** ADR 0015/0016 — recording/replay module topology and RecordingEventSchema@1.0 ([#65](https://github.com/dreamingdog0529/SignalRouter/issues/65)) ([b0a277f](https://github.com/dreamingdog0529/SignalRouter/commit/b0a277f1cab04b2871e57b0c8e59a319142c0dff))
* **v2:** close implementability gaps in the evidence and outcome specs ([#32](https://github.com/dreamingdog0529/SignalRouter/issues/32)) ([a21de02](https://github.com/dreamingdog0529/SignalRouter/commit/a21de021aafe4ce4a94c604e67d42286cd29404a))
* **v2:** close kernel implementability gaps in the execution specs ([#34](https://github.com/dreamingdog0529/SignalRouter/issues/34)) ([6257e4e](https://github.com/dreamingdog0529/SignalRouter/commit/6257e4e0f53e04fdb61bbbf02e09eb9c2f3de926))


### Miscellaneous

* **deps:** bump actions/checkout from 7.0.0 to 7.0.1 ([#45](https://github.com/dreamingdog0529/SignalRouter/issues/45)) ([a354039](https://github.com/dreamingdog0529/SignalRouter/commit/a3540395e275b8c5c5d27ab86eafdd8a081e848f))
* **deps:** bump github/codeql-action from 4.37.1 to 4.37.3 ([#42](https://github.com/dreamingdog0529/SignalRouter/issues/42)) ([bbf25d5](https://github.com/dreamingdog0529/SignalRouter/commit/bbf25d58f0fc9ff6b14eaf071c8f7daaafa954fb))
* **deps:** bump github/codeql-action/upload-sarif from 4.37.1 to 4.37.3 ([#44](https://github.com/dreamingdog0529/SignalRouter/issues/44)) ([0cdb0ff](https://github.com/dreamingdog0529/SignalRouter/commit/0cdb0ff4131927ce039145184a1b4470e0283f95))
* **deps:** bump ossf/scorecard-action from 2.4.3 to 2.4.4 ([#43](https://github.com/dreamingdog0529/SignalRouter/issues/43)) ([a82ea56](https://github.com/dreamingdog0529/SignalRouter/commit/a82ea56e9f85d9ddc8545271347562bc5795d1cf))
...
* **protocol:** serialize the session harness main-thread post onto one pump ([#64](https://github.com/dreamingdog0529/SignalRouter/issues/64)) ([d6579fe](https://github.com/dreamingdog0529/SignalRouter/commit/d6579fe4b9fa91a2417e71a8ed07ec781c1b4c07))
...
* **v2:** add allocation measurement harness and record the performance baseline ([#49](https://github.com/dreamingdog0529/SignalRouter/issues/49)) ([0f42c25](https://github.com/dreamingdog0529/SignalRouter/commit/0f42c254c72da7d7b95d69c7a90b918244f1d1f4))
* **v2:** add semantic oracle and API surface safety net for the performance track ([#48](https://github.com/dreamingdog0529/SignalRouter/issues/48)) ([c7a8ead](https://github.com/dreamingdog0529/SignalRouter/commit/c7a8ead9c0019396c9c43290db9531b28c5bf9e0))
